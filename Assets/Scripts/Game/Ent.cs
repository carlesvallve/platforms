...
public class Ent : MonoBehaviour {
  ...
  protected virtual void SetInput() {
    ...
    // todo: we should not apply friction to the input, but to the movement itself
    // apply friction
    input.x *= 0.99f;
  ...
  public void SetJump(bool isJumpingDown, float intensity = 1, bool escapeCheck = false) {
