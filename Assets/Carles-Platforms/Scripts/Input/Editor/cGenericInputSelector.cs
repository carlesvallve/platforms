...
public class cGenericInputSelector : PopupWindowContent {
  public cGenericInputSelector(string label, string lastInput, bool drawKeys, bool isUnityInput, UnityEngine.Events.UnityAction<string, bool> onSelectInput) {
    this.label = label;
