...
namespace Carles
{
  public class cInput : MonoBehaviour
  {
    ...
    private static cInput _instance;
    public static cInput instance
    {
      get
      {
        if (_instance == null)
        {
          _instance = GameObject.FindObjectOfType<cInput>();
          if (_instance == null)
          {
            _instance = new GameObject("cInputType").AddComponent<cInput>();
            return _instance;
          }
        }
        return _instance;
    ...
    public cHUDController hud;

    void Start()
    {
      if (hud == null) hud = cHUDController.instance;
  ...
  {
    protected InputDevice inputDevice { get { return cInput.instance.inputDevice; } }
    ...
    public string buttonName
    {
      get
      {
        ...
        {
          if (cInput.instance.inputDevice == InputDevice.MouseKeyboard) return keyboard.ToString();
          else if (cInput.instance.inputDevice == InputDevice.Joystick) return joystick;
          else return mobile;
        }
        return string.Empty;
      }
    ...
    public bool isKey
    {
      get
      {
        if (cInput.instance != null && !isUnityInput)
        {
